...
def wizard_parecer_view(request, id):
    ...
    context = {
        ...
        'has_prescricao_intercorrente_bienal': parecer.has_prescricao_intercorrente_bienal,
        ...
        'julgador_prescricao_intercorrente_bienal': parecer.julgador_prescricao_intercorrente_bienal,
