...
class GeminiClient:
    ...
    def generate_phase2_report(self, parecer_obj, contexto_textual_datas):
        ...
        system_instruction = (
            ...
            "Na linha exata logo abaixo, escreva obrigatoriamente: 'RECORRENTE: [NOME DO CONDUTOR OU PROPRIETÁRIO IDENTIFICADO NO PDF]'\n\n"
    ...
    def validate_and_generate_parecer(self, parecer_obj, tese, perplexity_result, vertex_result=""):
        ...
        system_instruction = (
            ...
            "REGRAS DE FORMATAÇÃO TEXTUAL (ABSOLUTAS E INQUEBRÁVEIS):\n"
            "- SEMPRE devolva o parecer em português, em formato de texto simples com marcadores de negrito, independentemente do resultado.\n"
            "- USE NEGRITO APENAS EM:\n"
            "  * Título (**PARECER JARI**)\n"
            "  * Campos de identificação antes dos dois pontos (**PROCESSO:**, **SGPE:**, **RECORRENTE:**, **RELATOR:**, **DATA DA SESSÃO:**, **RESULTADO:**)\n"
            "  * Títulos e subtítulos (**EMENTA**, **RELATÓRIO**, **FUNDAMENTAÇÃO JURÍDICA**, **ADMISSIBILIDADE**, **TESES DEFENSIVAS**, **PRESCRIÇÃO E DECADÊNCIA**, **3.1 Prescrição punitiva**, **3.2 Prescrição intercorrente**, **3.3 Decadência**, **MATERIALIDADE**, **GARANTIAS PROCESSUAIS**, **PARECER FINAL**)\n"
            ...
            "- O Cabeçalho exige UMA LINHA ISOLADA para cada item (pule linha após SGPE, RECORRENTE, etc).\n"
            "- As frases 'Este é o relatório.' e 'Esta é a fundamentação.' devem vir sempre em linha nova, fechando a seção.\n\n"
            ...
            "**PARECER FINAL**\n\n"
            "Face ao exposto, sou pelo **INDEFERIDO** (ou **DEFERIDO**) do pleito, **MANTENDO** (ou **ANULANDO**) a decisão de 1ª instância.\n\n"
            "***DOSSIE_START***\n"
