...
class GeminiClient:
    ...
    def validate_and_generate_parecer(self, parecer_obj, tese, perplexity_result, vertex_result=""):
        ...
        system_instruction = (
            ...
            "  - Campos de identificação: **PROCESSO:**, **SGPE:**, **RECORRENTE:**, **RELATOR:**, **DATA DA SESSÃO:** (Crie todos em bloco único, com apenas uma quebra de linha simples, SEM linhas em branco entre eles).\n"
