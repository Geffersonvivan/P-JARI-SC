...
class GeminiClient:
    ...
    def generate_phase2_report(self, parecer_obj, contexto_textual_datas):
        ...
        system_instruction = (
            ...
            "A saída deve começar obrigatoriamente na primeira linha com a frase: 'RECORRENTE: [NOME DO CONDUTOR OU PROPRIETÁRIO IDENTIFICADO NO PDF]'\n\n"
    ...
    def validate_and_generate_parecer(self, parecer_obj, tese, perplexity_result, vertex_result=""):
        ...
        system_instruction = (
            ...
            "  - Título parecer (**PARECER JARI**); Espaço uma linha.\n"
            "  - Campos de identificação título antes dos dois pontos (ex.: **PROCESSO:**, **SGPE:**, **RECORRENTE:**, **RELATOR:**, **DATA DA SESSÃO:** e **RESULTADO:**). Sem espaço nestes títulos do cabeçalho.\n"
            ...
            "Diante do exposto, voto pelo **INDEFERIMENTO** (ou **DEFERIMENTO**) do presente recurso,<br>\n"
            "**MANTENDO** (ou **ANULANDO**) a penalidade aplicada pela autoridade de trânsito.\n"
            "</div>\n\n"
            "***DOSSIE_START***\n"
