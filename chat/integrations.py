...
class GeminiClient:
    ...
    def analyze_tese(self, parecer_obj, tese, perplexity_result, vertex_result):
        ...
        system_instruction = (
            ...
            "   - Transcrever síntese objetiva da alegação, em apenas 2 linhas, no formato: 'Tese X – Síntese: ...'.\n"
            "   - Confrontar com a prova constante no AIT e no processo, aplicando a regra de presunção de legitimidade acima, SEM acrescentar fatos não documentados.\n"
    ...
    def validate_and_generate_parecer(self, parecer_obj, tese, perplexity_result, vertex_result=""):
        ...
        system_instruction = (
            ...
            "5. ACATAMENTO DO JULGADOR: Sobre as \"Teses Defensivas\", incorpore apenas o raciocínio da tese já escolhida na fase anterior, sem argumentar contra.\n\n"
            "GERAR O PARECER SEGUINDO ESTRITAMENTE ESTA ESTRUTURA FIXA (Mantenha formatações, letras maiúsculas e recuos se houver. O Cabeçalho exige UMA LINHA para cada item):\n\n"
            "PARECER JARI\n\n"
            ...
            "DATA SESSÃO: {A Data de Sessão deve ser preenchida aqui via prompt}\n"
            "RESULTADO: {DEFERIDO ou INDEFERIDO conforme lógicas acima}\n\n"
            "EMENTA\n\n"
            "Texto em MAIÚSCULO, objetivo, contendo: infração + tese(s) + admissibilidade + prescrição/decadência + resultado. (MÁXIMO 3 LINHAS)\n\n"
            "RELATÓRIO\n\n"
            "Síntese objetiva dos fatos, notificações e recursos. (MÁXIMO 6 LINHAS)\n"
            "Este é o relatório.\n\n"
            ...
            "Infração: [Data]\n"
            "Instauração do processo administrativo: [Data]\n"
            "Outras datas importantes: [Datas]\n"
            ...
            "Protocolo do recurso JARI: [Data]\n"
            "Data do julgamento: [Data]\n"
            "O intervalo entre os marcos corresponde a aproximadamente [dias], (inferior/igual/superior) ao prazo de três anos (1095 dias) previsto para prescrição intercorrente.\n"
            "+ explicação normativa.\n"
            "+ conclusão: configurada / não configurada.\n\n"
            "3.3 Decadência\n"
            "Regime temporal aplicado.\n"
            "+ explicação normativa.\n"
            "+ Conclusão: configurada / não configurada.\n\n"
            "MATERIALIDADE\n"
