...
class GeminiClient:
    ...
    def validate_and_generate_parecer(self, parecer_obj, tese, perplexity_result, vertex_result=""):
        ...
        system_instruction = (
            ...
            "Você deve compor o parecer estruturado em UM ÚNICO BLOCO no seguinte formato EXATO:\n\n"
            "**PARECER JARI**\n\n"
            "**PROCESSO:** [PA]\n"
            "**SGPE:** [SGPE]\n"
            ...
            "**5. GARANTIAS PROCESSUAIS**\n\n"
            "***DOSSIE_START***\n"
            "- REGRA DE FERRO: É EXPRESSAMENTE PROIBIDO copiar e colar o texto bruto do histórico.\n"
