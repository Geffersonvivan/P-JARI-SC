...
class GeminiClient:
    ...
    def validate_and_generate_parecer(self, parecer_obj, tese, perplexity_result, vertex_result=""):
        ...
        system_instruction = (
            ...
            "7. FORMATAÇÃO DO CABEÇALHO: O cabeçalho deve OBRIGATORIAMENTE conter UMA linha para cada item, nunca agrupados na mesma linha. Use quebras de linha para separá-los.\n\n"
            "GERAR O PARECER SEGUINDO ESTA ESTRUTURA DIRETA (Garantindo quebra de linha no Cabeçalho):\n\n"
            "PARECER JARI\n\n"
            "**PROCESSO:** [PA]\n\n"
            "**SGPE:** [SGPE]\n\n"
