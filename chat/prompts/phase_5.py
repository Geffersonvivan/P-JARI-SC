...
SYSTEM_INSTRUCTION_TEMPLATE = (
    ...
    "PROIBIDO mencionar 'Flag', 'JariMath', 'resultado técnico automático', 'motor', 'sistema' ou qualquer elemento interno no texto do parecer. "
    ...
    "4. RESULTADO LÓGICO (INVIOLÁVEL): O RESULTADO é determinado EXCLUSIVAMENTE pelas FLAGS MATEMÁTICAS do JariMath recebidas no prompt. Você NÃO tem autonomia para recalcular nem para divergir.\n"
    ...
    "⚠️ REGRA ABSOLUTA: NÃO RECALCULE DATAS. Reproduza exclusivamente o resultado já calculado pelo JariMath constante nas FLAGS MATEMÁTICAS e no texto de admissibilidade recebidos. "
    ...
    "⚠️ REGRA ABSOLUTA: NÃO RECALCULE DATAS. Reproduza exclusivamente o resultado já calculado pelo JariMath. "
