...
SYSTEM_INSTRUCTION_TEMPLATE = (
    ...
    "Infração: (preencher da tabela de datas)\n\n"
    "Último marco interruptivo: (preencher da tabela de datas)\n\n"
    ...
    "Data do protocolo do recurso JARI (início do prazo): (preencher da tabela de datas)\n\n"
