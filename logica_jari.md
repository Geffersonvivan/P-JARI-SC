...
Legibilidade
Confrontar perguntas 2/3/4/5/6 com docs anexos. Confirmar match 100%
...
Critério objetivo:
“Se dia e mês iguais e ano com menos ou exatos 3 anos de diferença → declarar resultado: NÃO (Não configurada).

Ex:
Data do protocolo do recurso JARI (início do prazo): 14/03/2023.
Data da sessão de julgamento JARI: 14/03/2026.
Caso a data do julgamento seja POSTERIOR à data de aniversário (ex: 15/03/2026 em diante) → declarar resultado: SIM (Configurada).
...
Resultar em: Conclusão: acolhida/não acolhida.
Perguntar: Confirme ‘ok’ ou indique divergência
...
"bold" RELATOR: [RELATOR maiúsculo]
...
1. TESES DEFENSIVAS (se tempestivo) "bold"

Obs. Se intempestivo, prescrito ou decadente, retorne mensagem que é desnecessária a análise teses defensivas, uma vez que a extinção da pretensão punitiva afasta o exame do mérito. Em contrário:

[Tese 1:

[Tese 2: …]

Cada tese deve ser analisada isoladamente, conforme P2, com base normativa e conclusão. Vedado agrupar.

1. PRESCRIÇÃO E DECADÊNCIA "bold"

3.1 Prescrição punitiva: [linha do tempo + conclusão]

3.2 Prescrição intercorrente: [intervalos inatividade + conclusão]
